...
public final class GameVar {
    ...
    // Paddle
    public static final int INIT_PADDLE_X = GlobalVar.WIDTH / 2 - 50;
    public static final int INIT_PADDLE_Y = GlobalVar.HEIGHT - 30;
    ...
    public static final int N_OF_WALLS_LEFT_RIGHT = GlobalVar.HEIGHT / HEIGHT_OF_WALLS;
    public static final int N_OF_WALLS_TOP = GlobalVar.WIDTH / WIDTH_OF_WALLS;


    // Ball
    public static final int INIT_BALL_X = GlobalVar.WIDTH / 2 - 10;
    public static final int INIT_BALL_Y = GlobalVar.HEIGHT - 60;
    public static final float SPEED_OF_BALL = 300.0F;
